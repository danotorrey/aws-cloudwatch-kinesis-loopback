 ...
 * Initial code obtained from https://docs.aws.amazon.com/streams/latest/dev/kcl2-standard-consumer-java-example.html
 */
public class LoopbackTester {
    ...
    public static void main(String... args) {
        ...
        new LoopbackTester(streamName, region).run();
    }
    ...
    private LoopbackTester(String streamName, String region) {
